      ...
      foreach ($velas as $vela): ?>
        <div class="categoria">
          ...
          <div class="card-info">
            ...
            <a href="agregar.php?producto=<?= urlencode($vela[1]) ?>&precio=<?= urlencode($vela[2]) ?>&imagen=img/<?= $vela[0] ?>&descuento=0"
      ...
      foreach ($utensilios as $item): ?>
        <div class="categoria">
          ...
          <div class="card-info">
            ...
            <a href="agregar.php?producto=<?= urlencode($item[1]) ?>&precio=<?= urlencode($item[2]) ?>&imagen=img/<?= $item[0] ?>&descuento=15"
              class="btn btn-success">Comprar</a>
